...
export default function Home() {
    return (
        <div className='bg-dark text-wrap'>
            ...
            <h1 style={{ color: 'white' }}><u>About <span style={{ color: 'orange' }}>UPAAC</span></u></h1>
            <div className='part2 d-flex justify-content-between'>
                ...
                <div className='video container mx-5 my-5'>
                    <iframe width="500" height="315" src="https://www.youtube.com/embed/P6OxEb1pKfo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
            ...
            <div className='part3' style={{ color: 'white' }}>
                <h1 style={{ color: 'white' }}><u>Why <span style={{ color: 'orange' }}>Choose UPAAC?</span></u></h1>
                ...
                <div className='reasons'>
                    <div className='row my-2'>
                        <span className='badge bg-primary  col-2'>Expert Astronomers</span>
                        <span className='badge bg-primary  col-2'>24x7, 365 Days Availability</span>
                        <span className='badge bg-primary  col-2'>Instant Access Worldwide</span>
                    </div>
                    <div className='row my-2'>
                        <span className='badge bg-primary  col-2'>Accurate Remedial Solutions</span>
                        <span className='badge bg-primary  col-2'>Privacy Guaranteed</span>
                        <span className='badge bg-primary  col-2'>Trusted by many</span>
                    </div>
                </div>
            </div><br/>
            <p className='partition' style={{ width: '100%', height: '0.5vh', backgroundColor: 'orange', marginBottom: '0' }}></p>
